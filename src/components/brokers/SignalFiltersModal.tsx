        ...
        <div className={`border border-${color}-200 rounded-lg p-4`}>
          <div className="flex items-center justify-between mb-3">
            ...
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
                checked={directionFilters.trade_grade?.enabled ?? false}
        ...
        <div className={`border border-${color}-200 rounded-lg p-4`}>
          <div className="flex items-center justify-between mb-3">
            ...
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
                checked={directionFilters.trade_score?.enabled ?? false}
        ...
        <div className={`border border-${color}-200 rounded-lg p-4`}>
          <div className="flex items-center justify-between mb-3">
            ...
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
                checked={directionFilters.entry_phase?.enabled ?? false}
        ...
        <div className={`border border-${color}-200 rounded-lg p-4`}>
          <div className="flex items-center justify-between mb-3">
            ...
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
                checked={directionFilters.adx?.enabled ?? false}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                type="number"
                value={directionFilters.adx?.min_value ?? 0}
            ...
            <div>
              ...
              <input
                type="number"
                value={directionFilters.adx?.max_value ?? 100}
        ...
        <div className={`border border-${color}-200 rounded-lg p-4`}>
          <div className="flex items-center justify-between mb-3">
            ...
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
                checked={directionFilters.volume?.enabled ?? false}
          ...
          <div>
            ...
            <input
              type="number"
              value={directionFilters.volume?.min_avg_volume_5d ?? 0}
        ...
        <div className={`border border-${color}-200 rounded-lg p-4`}>
          <div className="flex items-center justify-between mb-3">
            ...
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
                checked={directionFilters.price_range?.enabled ?? false}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                type="number"
                value={directionFilters.price_range?.min_price ?? 0}
            ...
            <div>
              ...
              <input
                type="number"
                value={directionFilters.price_range?.max_price ?? 1000000}
        ...
        <div className={`border border-${color}-200 rounded-lg p-4`}>
          <div className="flex items-center justify-between mb-3">
            ...
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
                checked={directionFilters.dist_ema21_atr?.enabled ?? false}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                type="number"
                step="0.1"
                value={directionFilters.dist_ema21_atr?.min_value ?? -10.0}
            ...
            <div>
              ...
              <input
                type="number"
                step="0.1"
                value={directionFilters.dist_ema21_atr?.max_value ?? 10.0}
        ...
        <div className={`border border-${color}-200 rounded-lg p-4`}>
          <div className="flex items-center justify-between mb-3">
            ...
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
                checked={directionFilters.volume_ratio?.enabled ?? false}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                type="number"
                step="0.1"
                value={directionFilters.volume_ratio?.min_value ?? 0.0}
            ...
            <div>
              ...
              <input
                type="number"
                step="0.1"
                value={directionFilters.volume_ratio?.max_value ?? 10.0}
        ...
        <div className={`border border-${color}-200 rounded-lg p-4`}>
          <div className="flex items-center justify-between mb-3">
            ...
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
                checked={directionFilters.di_spread?.enabled ?? false}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                type="number"
                value={directionFilters.di_spread?.min_value ?? 0}
            ...
            <div>
              ...
              <input
                type="number"
                value={directionFilters.di_spread?.max_value ?? 100}
        ...
        <div className={`border border-${color}-200 bg-${color}-50 rounded-lg p-4`}>
          <div className="flex items-center justify-between mb-3">
            ...
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
                checked={directionFilters.rocket_rule?.enabled ?? false}
