  ...
  return (
    <>
      ...
      <tr className="hover:bg-gray-50 transition-colors hidden md:table-row">
        ...
        <td className="px-4 py-3 text-sm text-gray-900 transition-all duration-150">
        ...
        <td colSpan={12} className="p-0">
          <div className="bg-white border-b border-gray-200 p-4 hover:bg-gray-50 transition-colors">
            <div className="flex items-start justify-between gap-3 mb-3">
              <div className="flex items-start gap-3 flex-1 min-w-0">
                <input
                  ...
                  checked={isSelected}
                  onChange={() => onToggleSelect(gtt.id)}
                  className="w-4 h-4 text-blue-600 rounded focus:ring-2 focus:ring-blue-500 mt-1 flex-shrink-0"
                />
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {showBreakeven && (
                      <div className="flex items-center gap-1 px-1.5 py-0.5 bg-green-100 text-green-700 rounded text-xs font-medium">
                        <TrendingUp className="w-3 h-3" />
                      </div>
                    )}
                  </div>
                  <div className="text-xs text-gray-500 mb-2">{gtt.exchange}</div>
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div>
                <div className="text-gray-500 mb-1">LTP</div>
                <div className="font-medium text-gray-900">₹{currentPrice?.toFixed(2) || 'N/A'}</div>
              </div>
              <div>
              ...
              {position && (
                <div>
                  <div className="text-gray-500 mb-1">Avg Price</div>
                  <span className={`font-medium px-2 py-1 rounded ${pnl !== null && pnl >= 0 ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                    ₹{position.average_price?.toFixed(2)}
                  </span>
                </div>
              )}
