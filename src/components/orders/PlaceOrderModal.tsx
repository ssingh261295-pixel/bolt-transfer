      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden min-h-0">
          ...
          {orderErrors.length > 0 && (
            <div className="bg-red-50 border border-red-200 text-red-700 px-3 py-2 rounded text-xs">
              <div className="font-medium mb-1">Order Errors:</div>
          ...
          <div>
            <label className="block text-xs font-medium text-gray-700 mb-1.5">Exchange</label>
            <select
          ...
          <div className="relative symbol-autocomplete">
            <label className="block text-xs font-medium text-gray-700 mb-1.5">Symbol</label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1.5">Transaction</label>
              <select
          ...
          <div
            ...
            style={{
              maxHeight: formData.order_type === 'LIMIT' ? '200px' : '0',
              opacity: formData.order_type === 'LIMIT' ? 1 : 0,
              pointerEvents: formData.order_type === 'LIMIT' ? 'auto' : 'none'
            }}
          >
            <div>
              ...
              <input
                ...
                required={formData.order_type === 'LIMIT'}
              />
            </div>
          </div>
          ...
          <div
            className="transition-all duration-200 overflow-hidden"
            style={{
              maxHeight: (formData.order_type === 'SL' || formData.order_type === 'SL-M') ? '200px' : '0',
              opacity: (formData.order_type === 'SL' || formData.order_type === 'SL-M') ? 1 : 0,
              pointerEvents: (formData.order_type === 'SL' || formData.order_type === 'SL-M') ? 'auto' : 'none'
            }}
          >
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1.5">Trigger Price</label>
              <input
                type="number"
                step="0.05"
                ...
                required={formData.order_type === 'SL' || formData.order_type === 'SL-M'}
              />
            </div>
          </div>
          ...
          {lastOrderDetails && (
            <div className="bg-green-50 border border-green-200 rounded p-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-green-600 text-white py-1.5 rounded text-sm hover:bg-green-700 transition"
              >
          ...
          <div className="flex items-center justify-between px-3 py-2.5 border-t border-gray-200 flex-shrink-0 bg-white">
            <div className="text-xs text-gray-600">
              {selectedBrokerIds.length > 0 && `${selectedBrokerIds.length} account(s) selected`}
            </div>
